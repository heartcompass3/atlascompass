...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const { mechanism, pillar, template, platform, knowledgeBaseText, readyText, anchorResearch, includeSecondaryGain, targetDemography, model = "gemini-2.5-flash" } = req.body;
